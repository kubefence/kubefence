...
GSD is optional here. This repo carries no `.planning/` tree and the `gsd-tools`
binary is not installed, so there are no planning artifacts to keep in sync —
edit and commit directly. GSD commands are available if you want them.
<!-- GSD:workflow-end -->
